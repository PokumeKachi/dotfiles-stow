return {
    ...
    require("plugins.languages.markdown.mdmath"),
    require("plugins.languages.markdown.nabla"),
    require("plugins.languages.markdown.render-markdown"),
    require("plugins.languages.markdown.zk"),
}
